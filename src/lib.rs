//! # Pulgamecanica - Vector and Matrix Library
//! 
...
/// The top-level namespace for the Pulgamecanica library.
pub mod pulgamecanica {
    ...
    // Optionally, re-export types for easier access from the top-level namespace.
